...
class Enemy:
    def __init__(self, map_width, map_height, snake_positions, food_position, obstacles_positions):
        self.map_width = map_width
        self.map_height = map_height
        self.direction = random.choice([(1,0), (-1,0), (0,1), (0,-1)])  # direção inicial aleatória
        self.snake_pos = self.generate_initial_position(snake_positions, food_position, obstacles_positions)

    def generate_initial_position(self, snake_positions, food_position, obstacles_positions):
        while True:
            ...
            collision = any(pos in snake_positions or pos == food_position or pos in obstacles_positions for pos in body)
            if not collision:
                return body
