...
pygame.display.set_caption("Cadastro do Jogador")
...
while cadastro_ativo:  #O LOOP VAI SE MANTER ENQUANTO O JOGADOR NAO TIVER SE CADASTRADO
    ...
    titulo = fonte.render("Digite seu nome e pressione Enter:", True, destaque) 
...
# Exibe no terminal 
print(f"Jogador cadastrado: {nome_cadastrado}")
pygame.quit()
